...
const StackCard = ({children,src,stack,index}:Props) => {
  return (
    <div className='bg-surface dark:bg-primary transition-colors ease-in dark:border-secondary dark:text-secondary px-4 py-3 border-2 border-foreground'>
        <div className='border-b-2 border-foreground dark:border-secondary pb-3 mb-2 flex justify-between items-center'>
