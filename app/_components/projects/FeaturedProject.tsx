...
const FeaturedProject = () => {
  return (
    <Link href={'/projects/id'} className=" group bg-surface pt-3 pb-2 px-4 border-2 border-foreground flex items-start justify-start gap-6 hover:bg-secondary transition-colors ease-in">
      ...
      <div className="w-full">
        ...
        <div className="flex w-full justify-between font-mono uppercase text-xs items-start">
          <span className=" text-gray-600">Fullistack • 2026</span>
          <svg
        ...
        <div>
          <h1 className="font-semibold text-lg">Ledger OS</h1>
