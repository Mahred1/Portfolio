...
const ProjectCard = ({
  ...
  return (
    <div className="border-2 border-foreground relative hover:border-accent">
      <Link
        href={`projects/${slug}`}
        className="absolute z-4 top-0 left-0 w-full h-full bg-none"
      ></Link>
      ...
      <div className="px-3 py-2 mt-3 bg-surface ">
        <div className="flex justify-between items-center ">
          ...
          <span className="font-mono text-xs opacity-80 border px-1 py-0.5 ">
            {category}
          </span>
        </div>
        ...
        <div className="flex w-full gap-2   border-t-2 justify-between mt-5 pt-4">
          <Link
            target="_blank"
            className="flex z-5  gap-1 w-full transition-colors ease-in items-center justify-center bg-surface text-foreground border-foreground border-2 hover:text-surface hover:bg-foreground text-sm font-medium py-2"
            href={repoLink}
          >
            <svg
          ...
          <Link
            target="_blank"
            className="flex z-5 gap-1 transition-colors ease-in items-center border-2 border-foreground hover:border-accent hover:text-foreground  hover:bg-accent w-full justify-center bg-foreground text-surface text-sm font-medium py-2"
            href={liveLink}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
